...
import com.lims.kewaiban.bean.City;
import com.lims.kewaiban.dao.DBHelper;
import com.lims.kewaiban.widget.MyLetterListView;
import com.lims.kewaiban.widget.MyLetterListView.OnTouchingLetterChangedListener;
...
public class LocationListActivity extends Activity {
	...
	private final String lngCityName = "正在定位所在位置..";

	@Override
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.main);
		personList = (ListView) findViewById(R.id.lv_city);
		allCity_lists = new ArrayList<City>();
		letterListView = (MyLetterListView) findViewById(R.id.mlv_letter);
		letterListView
			...
			if (viewType == 1) {
				...
				if (convertView == null) {
					...
					convertView = inflater
							.inflate(R.layout.search_item, parent);
